...
//        switch (specialty) {
//            case "Math":
//                if (math != null) { subjectsToSchedule.add(math); subjectsToSchedule.add(math); }
//                if (physics != null) { subjectsToSchedule.add(physics); subjectsToSchedule.add(physics); }
//                if (english != null) subjectsToSchedule.add(english);
//                if (history != null) subjectsToSchedule.add(history);
//                if (chemistry != null) subjectsToSchedule.add(chemistry);
//                if (french != null) subjectsToSchedule.add(french);
...
//                break;
//            case "Lettre":
//                if (philosophy != null) { subjectsToSchedule.add(philosophy); subjectsToSchedule.add(philosophy); }
//                if (french != null) { subjectsToSchedule.add(french); subjectsToSchedule.add(french); }
//                if (english != null) subjectsToSchedule.add(english);
//                if (history != null) subjectsToSchedule.add(history);
//                if (chemistry != null) subjectsToSchedule.add(chemistry);
//                if (geography != null) subjectsToSchedule.add(geography);
...
//                break;
//            case "Technology":
//                if (technology != null) { subjectsToSchedule.add(technology); subjectsToSchedule.add(technology); }
//                if (math != null) { subjectsToSchedule.add(math); subjectsToSchedule.add(math); }
//                if (english != null) subjectsToSchedule.add(english);
//                if (history != null) subjectsToSchedule.add(history);
//                if (chemistry != null) subjectsToSchedule.add(chemistry);
